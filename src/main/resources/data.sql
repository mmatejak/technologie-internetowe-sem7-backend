insert into SERVICE (ID, CREATED_DATE_TIME, LAST_MODIFIED_DATE_TIME, PRICE, TYPE)
values (1, CURRENT_DATE, CURRENT_DATE, 100, 'WEZWANIE_ASSISTANCE'),
       (2, CURRENT_DATE, CURRENT_DATE, 150, 'ZGLOSZENIE_KOLIZJI');

insert into ADDRESS (ID, CREATED_DATE_TIME, LAST_MODIFIED_DATE_TIME, POST_CODE, STREET, STREET_NUMBER, TOWN)
...
insert into CLIENT (ID, CREATED_DATE_TIME, LAST_MODIFIED_DATE_TIME, EMAIL, NAME, PHONE_NUMBER, SURNAME, ADDRESS_ID)
...
insert into NOTIFICATION (ID, CREATED_DATE_TIME, LAST_MODIFIED_DATE_TIME, DELIVERY_TIME, DESCRIPTION, CLIENT_ID, SERVICE_ID)
